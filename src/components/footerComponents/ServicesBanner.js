...
function ServicesBanner(props) {
    return (
        <div className='servicesBanner-container'>
            <div className='servicesBanner-delivery'>
            ...
            <div className='servicesBanner-support'>
            ...
            <div className='servicesBanner-exchange_return'>
            ...
            <div className='servicesBanner-standardPrice'>
