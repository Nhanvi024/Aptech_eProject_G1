        ...
        <div className='checkout-payment col-sm-4'>
            ...
            <div className='checkout-paymentMethod'>
                ...
                <div id='bank-info'>
                    ...
                    <p className='bank-info-name'><span className='bank-info-title'>Account Name:</span><span className='bank-info-info'>FPT Aptech</span></p>
                ...
                <div id='paypal-info'>
                    <PaypalPayment shipping={shipping} />
                </div>
