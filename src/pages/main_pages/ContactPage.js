            ...
            <div className='contactPageContainer'>
                ...
                <div className='contactPageContainer_row1'>
                    ...
                    <div className='contact_comment'>
                        ...
                        <form className='contact_comment-form'>
                            <input type=" text" className="contact_comment-input" placeholder="Your name *" />
                            <input type="text" className="contact_comment-input contact_comment-input1" placeholder="Your mail *" />
                            <input type="text" className="contact_comment-input contact_comment-input1" placeholder="Your phone *" />
                            <input type="text" className="contact_comment-input" placeholder="Title *" />
                            <textarea type="text" className="contact_comment-textarea" placeholder="Comment *" />
                            <button type="submit" className="contact_comment-send">SEND FEEDBACK</button>
                        </form>
                    </div>
                </div>
                <div className='contactPageContainer_row2'>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.3237228635567!2d106.66367477451728!3d10.786499259008922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ecb37e59e33%3A0xfe7c4d9f94f9e079!2zNTkwIMSQLiBDw6FjaCBN4bqhbmcgVGjDoW5nIDgsIFBoxrDhu51uZyAxMSwgUXXhuq1uIDMsIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaCA3MDAwMDAsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1713580613318!5m2!1svi!2s" width="100%" height="450px" style={{ border: '0' }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
