				...
				<div className="aboutPage-container container-xl text-center my-5">
					<div className="aboutPage-company">
						...
						<div className="aboutPage-company-content">
							...
							<p className="aboutPage-company-introduce mt-5">
								Ryana Calendars is selling Calendar and Diary products. The company advertises by distributing leaflets,
								printing in newspapers, v.v. However, due to the rapid development of the internet sector in this day and age,
								almost everyone is focused on technology. And so we decided to set up a website where people will get all the
								information about different products easily, quickly and appropriately. We who make these calendars and diaries
								strive to develop and bring the best sense of product selection and reference to users. Our calendars and
								diaries are printed with different messages and colors with the hope that people can better understand
