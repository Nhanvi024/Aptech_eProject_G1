...
function HomePage(props) {
    ...
    console.log("section1 Page: ", section1Page);
    ...
    let a = (section1Page + 1) * itemPerPage;
        ...
        <div className='homePageContainer container-fluid p-0'>
            ...
            <section className='section-calendar container-md p-0 mt-3'>
                <div className='row w-100 g-0 flex-row-reverse align-items-center'>
                    <div className='col-sm-8 bg-info px-3'>
                        <div className='row '>
                            <div className='row m-auto mb-2 bg-danger'>
                                <div className='col-8'>
                                ...
                                <div className='col-4 text-end'>
                                    <button className="btn btn-primary btn-lg me-1" onClick={handleSection1PagePrev}><p className='homepage-nextPrevButton'>&#8249;</p></button>
                                    <button className="btn btn-primary btn-lg ms-1" onClick={handleSection1PageNext}><p className='homepage-nextPrevButton'>&#8250;</p></button>
                                </div>
                            </div>
                            <div className='row m-auto bg-warning align-items-center' style={{height:"480px"}}>
                                {products.length === 0 &&
                    ...
                    <div className='col-sm-4 bg-primary homepage-notebookCarousel-container p-3'>
                        <div id="homepage-notebookCarousel" className="carousel slide text-center" data-bs-ride="carousel">
                            ...
                            {/* <!-- Left and right controls --> */}
                            <button className="carousel-control-prev" data-bs-target="#notebookCarousel" data-bs-slide="prev">
                                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                            </button>
                            <button className="carousel-control-next" data-bs-target="#notebookCarousel" data-bs-slide="next">
                                <span className="carousel-control-next-icon" aria-hidden="true"></span>
                            </button>
                        </div>
                    </div>
